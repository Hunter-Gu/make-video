...
export type RenderContext = {videoId: string; config: JsonObject; composition: JsonObject; production: JsonObject; outputs: Record<string, string>};
...
export const loadRenderContext = (videoId: string): RenderContext => {
  ...
  return {videoId, config, composition, production, outputs};
};
